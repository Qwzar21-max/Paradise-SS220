...
/datum/design/energy/kinetic_accelerator/experimental
 ...
 id = "EKA"
 req_tech = list("combat" = 7, "powerstorage" = 6, "engineering" = 6)
 build_type = PROTOLATHE
 materials = list(MAT_METAL = 15000, MAT_BLUESPACE = 1000, MAT_GLASS = 2000, MAT_DIAMOND = 3500)
